...
const InitializeMissions = () => {
    ...
    return (_jsxs("div", { className: "p-4 bg-gray-100 rounded-lg", children: [_jsx("h3", { className: "text-lg font-semibold mb-4", children: "Initialize Default Missions Data" }), _jsx("p", { className: "text-sm text-gray-600 mb-4", children: "This will add default missions data to Firebase. Only run this once!" }), _jsx("button", { onClick: initializeMissions, disabled: loading, className: "bg-blue-500 hover:bg-blue-600 disabled:bg-blue-300 text-white px-4 py-2 rounded", children: loading ? 'Initializing...' : 'Initialize Missions' }), message && (_jsx("div", { className: "mt-4 p-2 rounded bg-white", children: message }))] }));
};
